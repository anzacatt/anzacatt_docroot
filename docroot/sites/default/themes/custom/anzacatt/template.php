...
function anzacatt_preprocess_html(&$variables) {
  ...
  $parliament_images = _anzacatt_prepare_images_json();
...
function _anzacatt_prepare_images_json() {
  $images = ['anzacatt' => ['parliament_images' => []]];
  $results = views_get_view_result('parliamentary_image_urls', 'block');
  foreach ($results as $result) {
    $images['anzacatt']['parliament_images'][] = file_create_url($result->file_managed_uri);
  }
